    ...
    class DogBreedsExample
    {
        ...
        static async Task<JsonDocument> CallDogBreedsAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;breed&quot;] &#x3D; &quot;beagle&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Dog Breeds API...\n");

            var result = await CallDogBreedsAPI();
