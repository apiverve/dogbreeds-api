...
namespace APIVerve.API.DogBreeds
{
...
#endif
    {
        ...
        {
            { "breed", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public DogBreedsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DogBreedsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public DogBreedsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(DogBreedsQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(DogBreedsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(DogBreedsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(DogBreedsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(DogBreedsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(DogBreedsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
