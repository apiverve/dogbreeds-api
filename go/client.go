...
const (
	baseURL        = "https://api.apiverve.com/v1/dogbreeds"
	defaultTimeout = 30 * time.Second
)

// Client is the Dog Breeds API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Dog Breeds API client.
...
// Execute makes a request to the Dog Breeds API with typed parameters.
//
