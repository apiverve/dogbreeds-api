// Package dogbreeds provides a Go client for the Dog Breeds API.
//
// For more information, visit: https://apiverve.com/marketplace/dogbreeds?utm_source=go&utm_medium=readme
package dogbreeds
...
// Request contains the parameters for the Dog Breeds API.
//
// Parameters:
//   - breed (required): string - The name of the dog breed to get information about
type Request struct {
	Breed string `json:"breed"` // Required
}
...
// ResponseData contains the data returned by the Dog Breeds API.
type ResponseData struct {
	Breed string `json:"breed"`
	FoundCount int `json:"foundCount"`
	FoundBreeds []FoundBreedsItem `json:"foundBreeds"`
}

// FoundBreedsItem represents an item in the FoundBreeds array.
type FoundBreedsItem struct {
	Name string `json:"name"`
	Weight WeightData `json:"weight"`
	Height HeightData `json:"height"`
	BredFor string `json:"bredFor"`
	Group string `json:"group"`
	LifeSpan LifeSpanData `json:"life_span"`
	Traits []string `json:"traits"`
}

// WeightData represents the weight object.
type WeightData struct {
	LowerLbs int `json:"lowerLbs"`
	UpperLbs int `json:"upperLbs"`
}

// HeightData represents the height object.
type HeightData struct {
	LowerInches int `json:"lowerInches"`
	UpperInches int `json:"upperInches"`
}

// LifeSpanData represents the life_span object.
type LifeSpanData struct {
	LowerYears int `json:"lowerYears"`
	UpperYears int `json:"upperYears"`
}
