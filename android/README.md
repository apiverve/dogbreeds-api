...
```gradle
dependencies {
    implementation 'com.github.apiverve:dogbreeds-api:1.1.13'
}
```
...
```java
import com.apiverve.dogbreeds.DogBreedsAPIClient;
import com.apiverve.dogbreeds.APIResponse;
import com.apiverve.dogbreeds.APIException;

// Initialize the client
DogBreedsAPIClient client = new DogBreedsAPIClient("YOUR_API_KEY");

try {
    // Prepare query parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("breed", "beagle");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/dogbreeds](https://docs.apiverve.com/ref/dogbreeds)
...
- **Documentation:** [https://docs.apiverve.com/ref/dogbreeds](https://docs.apiverve.com/ref/dogbreeds)
- **Issues:** [GitHub Issues](https://github.com/apiverve/dogbreeds-api/issues)
