 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/dogbreeds?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/dogbreeds';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\DogbreedsClient] {$message}\n";
        }
    }
}
